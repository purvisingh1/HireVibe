import { useState } from 'react'; // You need to import useState from React
        ...
        >
            <div className="relative">
                ...
                <div className='flex items-center justify-center max-w-7xl mx-auto'>
                    <form onSubmit={submitHandler} className='w-1/2 border border-gray-200 rounded-md p-4 my-10 bg-white relative z-10'>
